...
{
    CGRect frame = CGRectMake(0, 0, ScreenWidth - 40, 200);
...
- (void)makeAlertDescriptionLabel
{
    ...
    descriptionLabel.center = CGPointMake(alertView.frame.size.width/2 + 20, kAlertTitleLabelTopMargin + titleLabel.frame.size.height + kALertDescriptionLabelTopMargin);
